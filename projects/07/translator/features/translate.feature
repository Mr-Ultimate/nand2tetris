...
"""
  ...
  Scenario: Memory Access Basic Test
    Given a file derived from project file "MemoryAccess/PointerTest/PointerTest.vm"
    When I run `translate PointerTest.vm`
    Then a file named "PointerTest.asm" should exist
    And the file "PointerTest.asm" should contain exactly:
"""
@3030
D=A
@SP
...
"""
  Scenario: Memory Access Basic Test
    Given a file derived from project file "MemoryAccess/StaticTest/StaticTest.vm"
    When I run `translate StaticTest.vm`
    Then the exit status should be 0
    And a file named "StaticTest.asm" should exist
    And the file "StaticTest.asm" should contain exactly:
"""
@111
D=A
@SP
